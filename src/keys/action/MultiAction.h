...
class MultiAction final : public IKeyAction {
    ...
    template <typename T, typename... Args> [[maybe_unused]] void addInstance(T instance, Args... args) {
...
public:
    template <typename... Args> explicit MultiAction(Args... args) { addInstance(args...); }
